...
def assess_with_data_measures(sequence_file_path: str, target_file_path: str,
    ...
    data,_ = Bin.main_loader(focus_aligned,focus,elbo_path = identified_residues_folder)
    legends = ['Deep+', 'Deep-', 'Abs(Deep)']
...
if __name__ =="__main__":
    ...
    save_path = './TestResults/Antibodies/existing_analysis'
