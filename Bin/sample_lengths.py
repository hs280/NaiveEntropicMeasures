...
def plot_surfaces(directory_path, num_cycles, names, save_path):
    ...
    plt.savefig(os.path.join(save_path, dpi=1200), dpi=600, bbox_inches='tight')
    ...
    for name in names:
        ...
        plt.xscale('log')
        plt.tight_layout()
        plt.savefig(os.path.join(save_path, dpi=1200), dpi=600)
...
def plot_results(r2_data, rmse_data, lengths, max_seq_length, entropy_save_path):
    ...
    plt.tight_layout()
    plt.savefig(r2_plot_path, dpi=1200)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(rmse_plot_path, dpi=1200)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(r2_plot_10_path, dpi=1200)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(rmse_plot_10_path, dpi=1200)
    plt.close()
